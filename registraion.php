...
<div class="page-container">
  ...
  <h2 class="section-title">Training Registration Form</h2>

  <form action="" id="form" method="post">
    <!-- Package Section -->
    <div class="form-section">
      <h5><i class="fas fa-graduation-cap"></i>Course</h5>
      <div class="mb-4">
        <label for="schedule" class="form-label required">Type course name</label>
        <div class="input-with-icon">
          <i class="fas fa-book"></i>
          <input type="text" name="course" id="course" class="form-control" aria-describedby="emailHelp" placeholder="Course Name" required />
        </div>
    ...
    <div class="form-section">
      ...
      <div class="row g-4">
        ...
        <div class="col-md-6">
          ...
          <span id="numbererror" class="text-danger small"></span>
        </div>
        <div class="col-md-6">
          <label class="form-label required">Description</label>
          <textarea type="text" id="description" name="msg" class="form-control" placeholder="Tell us about your requirements" rows="4" required></textarea>
        </div>
        <span id="deserror" class="text-danger small"></span>
      </div>
    </div>
...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'keights.skills@gmail.com';           // Your Gmail address
    $mail->Password   = 'axrnlfbswqlshvbu';                    // Your App Password (no spaces)
    ...
    // Recipients
    $mail->setFrom('keights.skills@gmail.com', 'Skills Training'); // Ensure this is valid
    $mail->addAddress('Info@skillstraining.tech', 'Recipient');       // Ensure this is valid
    ...
    $mail->Body    = "Sender Name - $name <br> Sender Email - $email <br> Sender Mobile - $mob <br> Course Name - $course <br> Message - $msg";
